<div class="main-content blc">
  <div class="ctn">
    ...
    <p><a href="<?= racine() ?>/gestionpromotions">Cliquez ici pour retourner à l'affichage des promotions.</a></p>

    <?php $id_promotion = $data['promo_id']; ?>

    <form action="<?= racine() ?>/gestionpromotions/supprimer/<?= $id_promotion ?>" method="post">
